 ...
 *                   $ref: '#/components/schemas/Transaction'
 */
router.post("/create-transaction", validateMiddleware.validateSchema(transactionSchema), TransactionController.createTransaction);
/**
 * @swagger
 ...
 *                   $ref: '#/components/schemas/Transaction'
 */
router.put("/update-transaction/:id_transaction", validateMiddleware.validateSchema(transactionSchema), TransactionController.updateTrasaction);
